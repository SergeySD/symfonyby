...
class __TwigTemplate_55063c156622d3f297c71fa2f690d1a4 extends Twig_Template
{
    protected $parent;
...
";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '5'), "symfonyversion", array(), "any", false, 5), "html");
        echo "
...
";
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '8'), "phpversion", array(), "any", false, 8), "html");
        echo "<span style=\"margin: 0; padding: 0; color: #aaa\">|</span><span style=\"color: ";
        echo (($this->getAttribute($this->getContext($context, 'collector', '8'), "hasxdebug", array(), "any", false, 8)) ? ("#3a3") : ("#a33"));
        echo "\">xdebug</span><span style=\"margin: 0; padding: 0; color: #aaa\">|</span><span style=\"color: ";
        echo (($this->getAttribute($this->getContext($context, 'collector', '8'), "hasaccelerator", array(), "any", false, 8)) ? ("#3a3") : ("#a33"));
        echo "\">accel</span>
...
";
        // line 11
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '11'), "appname", array(), "any", false, 11), "html");
        echo "<span style=\"margin: 0; padding: 0; color: #aaa\">|</span>";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '11'), "env", array(), "any", false, 11), "html");
        echo "<span style=\"margin: 0; padding: 0; color: #aaa\">|</span>";
        echo (($this->getAttribute($this->getContext($context, 'collector', '11'), "debug", array(), "any", false, 11)) ? ("debug") : ("no-debug"));
        echo "<span style=\"margin: 0; padding: 0; color: #aaa\">|</span>";
        if ($this->getAttribute($this->getContext($context, 'collector', '11'), "url", array(), "any", false, 11)) {
            echo "<a style=\"color: #000\" href=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '11'), "url", array(), "any", false, 11), "html");
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '11'), "token", array(), "any", false, 11), "html");
            echo "</a>";
        } else {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '11'), "token", array(), "any", false, 11), "html");
        }
