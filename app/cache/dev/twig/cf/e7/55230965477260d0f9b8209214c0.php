...
class __TwigTemplate_cfe755230965477260d0f9b8209214c0 extends Twig_Template
{
    protected $parent;
...
";
        // line 5
        echo twig_escape_filter($this->env, sprintf("%.0f", ($this->getAttribute($this->getContext($context, 'collector', '5'), "time", array(), "any", false, 5) * 1000)), "html");
        echo " ms
";
    }
