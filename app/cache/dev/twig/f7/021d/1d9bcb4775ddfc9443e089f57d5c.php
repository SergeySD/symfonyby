...
";
    ...
    ";
            ...
            // line 21
            echo "        ";
            echo $this->env->getExtension('templating')->getContainer()->get('templating.helper.actions')->render("WebProfilerBundle:Exception:show", array("exception" => $this->getAttribute($this->getContext($context, 'collector', '21'), "exception", array(), "any", false, 21), "format" => "html"), array());
            // line 22
            echo "    ";
        }
    }
