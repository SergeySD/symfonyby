...
class __TwigTemplate_69d93ba886aff5ff3c7d3c1352676ea9 extends Twig_Template
{
    ...
    <table>
        ...
        echo "
            ";
        // line 33
        echo $this->env->getExtension('templating')->getContainer()->get('templating.helper.actions')->render("WebProfilerBundle:Profiler:searchBar", array("token" => $this->getContext($context, 'token', '33')), array());
        // line 34
        echo "
            ";
        // line 35
